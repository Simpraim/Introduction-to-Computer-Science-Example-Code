#Let's create a counter that counts to 5
a = 1
while a < 5: #While a is less than 5, do something...
 print(a)  #This is the something
 a = a + 1 #This changes the value of a so that you're not stuck in the loop
